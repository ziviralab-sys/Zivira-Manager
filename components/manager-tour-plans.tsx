...
import { Ban, Check, RefreshCw, Repeat, Users, X } from "lucide-react";
...
type ActionKind = "void" | "reassign" | "reject";
...
export function ManagerTourPlans() {
  ...
  async function runAction() {
    ...
    try {
      if (actionTarget.kind === "void") await apiClient.voidTourPlan(actionTarget.tp.tpId, reason);
